// Sticky Plugin v1.0.0 for jQuery é
// =============
...
(function($) {
    var defaults = {
        ...
        var scrollTop = $window.scrollTop(), documentHeight = $document.height(), dwh = documentHeight - windowHeight, extra = (scrollTop > dwh) ? dwh
                - scrollTop : 0;
